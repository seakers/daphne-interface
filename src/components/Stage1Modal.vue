<template>
    <div class="message-body">
        <p>That's it for the first stage of the experiment! Click the button to answer a survey and a test on what you just did. When you're done click on Continue to go to the second stage.</p>
