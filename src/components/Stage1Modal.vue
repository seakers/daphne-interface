<template>
    <div class="message-body">
        <p>That's it for the first stage of the experiment! Click the button to take the first exam. When you're done click on Continue to go to the second stage.</p>
        <a class="button" href="https://tamu.qualtrics.com/jfe/form/SV_b31PZ26Z6gAp1dP" target="_blank" v-on:click="changeButtons" v-show="firstButton">Take test</a>
