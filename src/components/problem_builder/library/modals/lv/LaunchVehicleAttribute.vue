    ...
    <div class="modal" v-bind:class="{ 'is-active': isActive }">
        ...
        <div class="modal-content" style="width: 400px !important;">
            <article class="message">
                <div class="modal-attribute-title">New Launch Vehicle Attribute</div>
...
<script>
    import { InsertLaunchVehicleAttribute } from '../../../../../scripts/launch-vehicle-queries';
    import { mapState, mapGetters } from 'vuex';

    export default {
        name: 'launch-vehicle-attribute',
        props: ['isActive'],
        data() {
            return {
                attribute_name: '',
        ...
        methods: {
            ...
            async create_attribute(){
                ...
                let new_orb_attribute = await this.$apollo.mutate({
                    mutation: InsertLaunchVehicleAttribute,
